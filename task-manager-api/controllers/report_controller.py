...
from utils.helpers import calculate_percentage, format_date, utc_now
...
def summary_report():
    ...
    # Busca todas as tasks uma única vez e reaproveita em memória
    # (elimina o N+1 que existia no loop de estatísticas por usuário).
    ...
    return {
        'generated_at': format_date(utc_now()),
        'overview': {
